...
public func saveLoginAccount(_ account: AppStoreAccount, for email: String) {
...
public func withAccount<T>(email: String, _ body: (inout AppStoreAccount) async throws -> T) async throws -> T {
