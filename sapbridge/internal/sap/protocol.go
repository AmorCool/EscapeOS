...
// defaultUserAgent mirrors the User-Agent ipatool sends on SAP setup requests.
// The original value came from pkg/http.DefaultUserAgent; it is inlined here so
// the sap bridge stays free of the wider ipatool module.
const defaultUserAgent = "Configurator/2.17 (Macintosh; OS X 15.2; 24C5089c) AppleWebKit/0620.1.16.11.6"
