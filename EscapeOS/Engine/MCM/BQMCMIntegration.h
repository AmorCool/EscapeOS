...
/// iOS 26 App Group "sacrifice" route: the app-group identifier this process
/// owns, used by bad_query to reach other App Group containers when direct
/// class-7 access is refused. Set this before any bad_query call that passes a
/// group_identifier. Defaults to a placeholder — must be replaced with the
/// App Group registered to EscapeOS's signing identity.
